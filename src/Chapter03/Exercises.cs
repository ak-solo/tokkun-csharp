public class Exercises
{
    ...
    {
        throw new NotImplementedException("問題 3-7 (Case1) を実装してください");
    }
    ...
    {
        throw new NotImplementedException("問題 3-7 (Case2) を実装してください");
    }

    // 問題 3-7 ケース3: 80点以上 → "優"、70点以上 → "良"、60点以上 → "可"、未満 → "不可"
    public static string Problem3_7_Case3(int score)
    {
        throw new NotImplementedException("問題 3-7 (Case3) を実装してください");
    }
